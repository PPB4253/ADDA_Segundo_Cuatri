...
public class Datos1 {
	...
	private static Integer presupuestoMax = 0;
	private static List<String> cualidades = List2.empty();
	private static List<Candidato> candidatos = List2.empty();
