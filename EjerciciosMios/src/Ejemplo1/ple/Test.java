...
public class Test {
	...
	public static void main(String[] args) throws IOException{		// IMPORTANTE PONER throws IOException
		...
		Datos.iniDatos("src/Ejemplo1/ple/ejemplo1_1.txt");
		...
		AuxGrammar.generate(Datos.class, 
				"src/Ejemplo1/ple/ejemplo1.lsi", 	// COGEMOS EL .lsi
				"src/Ejemplo1/ple/ejemplo1.lp");	// GENERAMOS EL .lp
		
		var sol = GurobiLp.gurobi("src/Ejemplo1/ple/ejemplo1.lp");	// EJECUTAMOS EL .lp
