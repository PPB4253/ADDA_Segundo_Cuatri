...
public class Test {
	...
	public static void main(String[] args) throws IOException{		// IMPORTANTE PONER throws IOException
		...
		DatosSubconjunto.iniDatos("src/Ejemplo2/ple/ejemplo2_1.txt");
		...
		AuxGrammar.generate(DatosSubconjunto.class, 
				"src/Ejemplo2/ple/ejemplo2.lsi", 	// COGEMOS EL .lsi
				"src/Ejemplo2/ple/ejemplo2.lp");	// GENERAMOS EL .lp
		
		var sol = GurobiLp.gurobi("src/Ejemplo2/ple/ejemplo2.lp");	// EJECUTAMOS EL .lp		TODOS LOS METODOS DE GUROBI HACEN LO MISMO PERO .gurobi() MAS ELEGANTE
