...
public class Test {
	...
	public static void main(String[] args) throws IOException{		// IMPORTANTE PONER throws IOException
		...
		DatosAlumnos.iniDatos("src/Ejemplo3/ple/ejemplo3_1.txt");
		...
		AuxGrammar.generate(DatosAlumnos.class, 
				"src/Ejemplo3/ple/ejemplo3.lsi", 	// COGEMOS EL .lsi
				"src/Ejemplo3/ple/ejemplo3.lp");	// GENERAMOS EL .lp
		
		var sol = GurobiLp.gurobi("src/Ejemplo3/ple/ejemplo3.lp");	// EJECUTAMOS EL .lp		TODOS LOS METODOS DE GUROBI HACEN LO MISMO PERO .gurobi() MAS ELEGANTE
