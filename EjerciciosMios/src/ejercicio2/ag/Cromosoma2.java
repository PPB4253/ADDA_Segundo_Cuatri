...
public class Cromosoma2 implements RangeIntegerData<Solucion2> {
	...
	private Double totalTiempoElab(List<Integer> value) {
		...
		if (tiempoElaboracion <= Datos2.getTiempoElabTotal()) {				// Como es una funcion de penalización si se cumple la conmdicion, no devolvemos nada, es decir, 0. SOLO NOS INTERESA CUANOD NO CUMPLE LA CONDICION
			return 0.0;
		}
